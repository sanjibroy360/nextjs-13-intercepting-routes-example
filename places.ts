export const places = [
  ...
  },
  {
    ...
    imageSrc:
      "https://res.cloudinary.com/dcngyw7qp/image/upload/v1685956681/museums-kolkata_diciqw.jpg",
  },
  {
    id: "belur-math",
    name: "Belur Math",
    description: `Belur Math in Kolkata is the headquarters of the Ramakrishna Math and Mission. Sprawling over forty acres of land on the west bank of the Hooghly River, it is visited by people from all over the world, irrespective of their religious beliefs.
    ...
    imageSrc:
      "https://res.cloudinary.com/dcngyw7qp/image/upload/v1685957410/belur-math_soo0yt.webp",
  },
  {
    id: "marble-palace",
    name: "Marble Palace",
  ...
  },
  {
    ...
    `,
    imageSrc:
      "https://res.cloudinary.com/dcngyw7qp/image/upload/v1685959267/st-paul-cathedral-kolkata_edrzlp.jpg",
  },
  {
    id: "boipara",
    name: "Boipara (College street)",
    description: `College street,also colloquially known as “Boi-Para” (book-mart), is a prominent center of Kolkata’s literary crowd. It is the largest second-hand book market in the world and largest book market in India. The inception of the name “College Street ” goes back to the time when the Hindu College was established in 1817. The Hindu School was also established in 1817. David Hare established the Hindu college with twenty scholars in 1817. Thus, the street on which the Hindu College was located came to be known as “College Street” under the Governorship of Lord Wellesley.Lord Wellesley first introduced the construction of planned road in Calcutta or Kolkata. In 2007, College street freatured among the famous landmarks of India that made it to Time Magazine’s “Best of Asia” list.`,
    imageSrc:
      "https://res.cloudinary.com/dcngyw7qp/image/upload/v1685959259/College-Street_dhjqmg.jpg",
  },
];
